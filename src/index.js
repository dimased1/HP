...
Строго JSON, структура:
{
  ...
  "news": [
    { "id": "1", "title": "...", "description": "максимально, но до 60 слов. Волшебная новость наиболее близкая к книжкам Гарри Поттера. Криминальная" },
    { "id": "2", "title": "...", "description": "15-20 слов. Локальная магическая новость Шотландии" },
    { "id": "3", "title": "...", "description": "20–30 слов. Короткая магическая новость про хогвартс или министерство магии, животных и так далее" }
  ],
...
- Новость №1 длиннее, остальные короче. Соблюдай количество слов!
