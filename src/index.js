...
function buildPromptForDate(dateStr) {
  return `Ты — генератор выдуманных газетных сводок. Создай JSON-объект для ежедневного выпуска "Ежедневный Пророк". Я живу в Великобритании, Шотландия — новости локализованы и магические. Максимально креативно, но серьезным тоном - драконы, магические рынки, сенсации и так далее.
...
Строго JSON, структура:
{
  ...
  "news": [
    ...
    { "id": "3", "title": "...", "description": "15–25 слов. Короткая магическая новость про магический мир" }
  ],
