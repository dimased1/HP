...
function buildPromptForDate(dateStr) {
  return `Ты — генератор выдуманных газетных сводок. Создай JSON-объект для ежедневного выпуска "Ежедневный Пророк". Я живу в Великобритании. Все по английскомуМаксимально креативно, но серьезным тоном. ВАЖНО соблюдать количество знаков.
...
Строго JSON, структура:
{
  ...
  "news": [
    ...
    { "id": "2", "title": "... До 55 знаков с пробелом", "description": "15-20 слов. До 150 знаков с пробелом. Локальная магическая смешная новость Шотландии " },
