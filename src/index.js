...
function buildPromptForDate(dateStr) {
  return `Ты — генератор выдуманных газетных сводок. Создай JSON-объект для ежедневного выпуска "Ежедневный Пророк". Я живу в Великобритании, Шотландия — новости локализованы и магические. Максимально креативно - драконы, магические рынки, сенсации.
...
Строго JSON, структура:
{
  ...
  "news": [
    { "id": "1", "title": "...", "description": "60–90 слов. Волшебная новость про персонажа из книг, Хогвартс, драконов, сенсацию." },
    { "id": "2", "title": "...", "description": "15–25 слов. Локальная магическая новость Шотландии" },
    { "id": "3", "title": "...", "description": "15–25 слов. Короткая магическая новость про магический мир, животный мир" }
  ],
