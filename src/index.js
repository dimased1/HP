...
function buildPromptForDate(dateStr) {
  return `Ты — генератор выдуманных газетных сводок. Создай JSON-объект для ежедневного выпуска "Ежедневный Пророк". Я живу в Великобритании. Максимально креативно, но серьезным тоном. ВАЖНО соблюдать количество знаков.
...
Строго JSON, структура:
{
  ...
  "news": [
    { "id": "1", "title": "... До 55 знаков с пробелом", "description": "от 40 до 60 слов. До 440 знаков с пробелом. Волшебная новость наиболее близкая к книжкам Гарри Поттера. Криминальная" },
