...
function buildPromptForDate(dateStr) {
  return `Ты — генератор выдуманных газетных сводок. Создай JSON-объект для ежедневного выпуска "Ежедневный Пророк". Я живу в Великобритании. Креативно, но серьезным тоном. ВАЖНО соблюдать количество знаков.
...
Строго JSON, структура:
{
  ...
  "Sensation": "Очень краткая сенсация(криминальная, не связанная с основными новостями) (5-10 слов До 40 символов с пробелом). ",
  "news": [
    { "id": "1", "title": "... До 55 знаков с пробелом", "description": "от 40 до 60 слов. До 440 знаков с пробелом. Волшебная новость наиболее близкая к книжкам Гарри Поттера. Можно и криминальную" },
    { "id": "2", "title": "... До 55 знаков с пробелом", "description": "15-20 слов. До 150 знаков с пробелом. Локальная магическая новость. Можно про животных, шотландию, министерство магии " },
    { "id": "3", "title": "... До 65 знаков с пробелом", "description": "20–25 слов. До 150 знаков с пробелом. Короткая магическая новость про хогвартс или министерство магии, животных и так далее" }
  ],
  "magic_tip": "Короткий магический совет (одно предложение, до 12 слов)",
  "galleon_rate": "1 Галеон (ʛ) = 1.1(это число менять незначительно) £",
  "horoscope": "Краткий гороскоп на день для магов до 10 слов. До 60 символов с пробелом." 
}
Требования:
- Заголовки 5–8 слов. Первый заголовок капсом, остальные не капсом. Обычным текстом. 
