...
function buildPromptForDate(dateStr) {
  return `Ты — генератор выдуманных газетных сводок. Создай JSON-объект для ежедневного выпуска "Ежедневный Пророк". Я живу в Великобритании. Максимально креативно, но серьезным тоном - драконы, магические штуки, сенсации и так далее.
